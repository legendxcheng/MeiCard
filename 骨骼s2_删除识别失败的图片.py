...
# 定义文件夹路径
folder_A = 'D:\\ComfyUI\ComfyUI_windows_portable_nvidia_cu118_or_cpu\\ComfyUI_windows_portable\\ComfyUI\\output\\'
folder_B = 'D:\\魅卡\\骨骼图\\全身Raw\\'
folder_C = 'D:\\魅卡\\骨骼图\\Raw\\'


# 定义需要检查的颜色列表
required_colors = [
    '#009933', '#009900', '#009999', '#006699', 
    '#999900', '#996600', '#339900', '#669900', '#993300', '#990000',
    '#000099', '#990099', '#990066', '#330099', '#660099'
]

required_fullbody_colors = [
    '#009933', '#009900', '#009999', '#006699', '#009966', '#003399',
    '#999900', '#996600', '#339900', '#669900', '#993300', '#990000',
    '#000099', '#990099', '#990066', '#330099', '#660099'
]
    ...
    if filename.lower().endswith('.png'):
        ...
        if all(color in pixels for color in required_colors_rgb):
            ...
            print(f"Copied {filename} to {folder_C}")
                ...
                # 检查图像是否包含所有指定颜色
        if all(color in pixels for color in required_fullbody_colors):
            # 如果包含所有指定颜色，则将文件复制到文件夹B
